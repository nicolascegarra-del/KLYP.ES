...
// Comprobamos si el usuario quiere ver una noticia en concreto
$ver_detalle = false;
$noticia = null;
...
<head>
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            .subtitle { font-size: 1rem !important; padding: 0 10px; }
...
<body style="background-color: #f4f7fa;">
                ...
                <?php if ($ver_detalle): ?>
                    ...
                    <div style="display: inline-flex; align-items: center; gap: 15px; flex-wrap: wrap; justify-content: center;">
                        ...
                        <span style="color: rgba(255,255,255,0.7); font-size: 0.95rem;">
                            <i class="far fa-calendar-alt"></i> Publicado el <?php echo date('d/m/Y', strtotime($noticia['fecha'])); ?>
                        </span>
                    </div>
                <?php else: ?>
                    ...
                    <span class="subtitle" style="display: block; max-width: 600px; margin: 0 auto; line-height: 1.6;">
                        Mantente al día con las últimas actualizaciones de nuestras aplicaciones y las noticias corporativas del ecosistema KLYP.
                    </span>
                <?php endif; ?>
            </div>
        </section>
    ...
    <?php if ($ver_detalle): ?>
        <div class="blog-post-content">
            ...
            <div style="font-size: 1.1rem; line-height: 1.8; color: #444; white-space: pre-wrap;"><?php echo htmlspecialchars($noticia['texto']); ?></div>
        ...
        <div class="blog-list-container">
            ...
            ?>
                <a href="blog.php?id=<?php echo $item['id']; ?>" class="blog-list-item">
                    <div class="blog-list-image">
                        <img src="<?php echo htmlspecialchars($item['imagen']); ?>" alt="Noticia">
                    </div>
                    ...
                    <div class="blog-list-content">
                        ...
                        <h2 style="margin: 0 0 15px 0; font-size: 1.5rem; color: var(--klyp-dark); line-height: 1.3;">
            ...
            ?>
                <div style="text-align: center; padding: 80px 20px; background: white; border-radius: 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.05);">
                    ...
                    <p style="color: var(--text-gray); font-size: 1.1rem;">Pronto compartiremos nuestras últimas novedades por aquí.</p>
                </div>
            <?php endif; ?>
        </div>
    <?php endif; ?>
